...
export default function Footer() {
  ...
  // Closing message "Jaga Customer. Jaga Omzet. Jaga Bisnis." ONLY allowed on Home (/) and Pricing (/pricing)
  const showClosingCTA = pathname === '/' || pathname === '/pricing';

  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      {/* FINAL CTA BAR - ONLY DISPLAYED ON HOME & PRICING */}
      {showClosingCTA && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="text-xs text-slate-400 max-w-sm leading-relaxed mb-4">
